ALTER TABLE public.paper_trades
  ...
  ADD COLUMN IF NOT EXISTS entry_slip_bps numeric,
  ADD COLUMN IF NOT EXISTS exit_slip_bps numeric,
  ADD COLUMN IF NOT EXISTS trigger_price numeric,
  ADD COLUMN IF NOT EXISTS spread_entry_bps numeric,
  ADD COLUMN IF NOT EXISTS spread_exit_bps numeric,
  ADD COLUMN IF NOT EXISTS latency_ms numeric,
  ADD COLUMN IF NOT EXISTS slip_cost_usd numeric,
  ...
  ADD COLUMN IF NOT EXISTS liq_price numeric,
  ADD COLUMN IF NOT EXISTS book_priced boolean;
